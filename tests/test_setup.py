...
class TestSetup(TestCase):
    ...
    @mock.patch("kfk.setup._download_kubectl")
    def test_update_kubectl_if_new_version_exists(self, mock_download_kubectl, mock_rename):
        setup()
        assert mock_download_kubectl.call_count == 1
    ...
    @mock.patch("kfk.setup.KUBECTL_VERSION", "x.x.x")
    @mock.patch("kfk.setup._download_kubectl")
    def test_update_kubectl_if_new_version_exists_with_custom_kubectl_path(self, mock_download_kubectl, mock_rename):
    ...
    @mock.patch("kfk.setup.KUBECTL_VERSION", "x.x.x")
    @mock.patch("kfk.setup._download_kubectl")
    def test_update_kubectl_if_new_version_exists_with_custom_kubectl_version(self, mock_download_kubectl, mock_rename):

...
from src.kfk.config import _get_processor_type
...
class TestKfkConfig(TestCase):
    @mock.patch("src.kfk.config._is_64_bit")
    @mock.patch("src.kfk.config.platform.uname")
    ...
    @mock.patch("src.kfk.config._is_64_bit")
    @mock.patch("src.kfk.config.os.uname")

...
![Build](https://github.com/systemcraftsman/strimzi-kafka-cli/workflows/Build/badge.svg) ![Integration Test](https://github.com/systemcraftsman/strimzi-kafka-cli/workflows/Integration%20Test/badge.svg) ![Deploy](https://github.com/systemcraftsman/strimzi-kafka-cli/workflows/Deploy/badge.svg) [![PyPI](https://img.shields.io/pypi/v/strimzi-kafka-cli)](https://pypi.org/project/strimzi-kafka-cli/) [![Downloads](https://static.pepy.tech/badge/strimzi-kafka-cli)](https://pepy.tech/project/strimzi-kafka-cli) [![License](https://img.shields.io/badge/license-Apache--2.0-blue.svg)](http://www.apache.org/licenses/LICENSE-2.0) [![Strimzi](https://img.shields.io/badge/Strimzi-1.0.0-blue)](https://github.com/strimzi/strimzi-kafka-operator/releases/tag/1.0.0) [![MCP Server](https://badge.mcpx.dev?type=server&features=tools 'MCP Server')](https://github.com/systemcraftsman/strimzi-kafka-cli#mcp-server)
...
> Installing the CLI by using Homebrew already uses a virtual environment, so you don't have to worry about your main Python environment. For MCP server support, use pip or pipx install instead.
